...
const CONFIG = {
  ...
  STARTER_FEATURE_1_TITLE_1: 'Language Learning',
  STARTER_FEATURE_1_TITLE_1_CN: '语言学习',
  STARTER_FEATURE_1_TITLE_1_RO: 'Învățarea limbii',
  ...
  STARTER_FEATURE_1_BUTTON_URL: '/ll',

  STARTER_FEATURE_2_TITLE_1: 'Travel Chinese',
  STARTER_FEATURE_2_TITLE_1_CN: '中国旅游',
  STARTER_FEATURE_2_TITLE_1_RO: 'Chineză pentru călătorii',
  STARTER_FEATURE_2_TEXT_1: 'Quick travel Chinese, practical conversations and cultural etiquette guidance',
  STARTER_FEATURE_2_TEXT_1_CN: '旅行中文速成，实用会话与文化礼仪指导',
  STARTER_FEATURE_2_TEXT_1_RO: 'Chineză rapidă pentru călătorii, conversații practice și ghid de etichetă culturală',
  ...
  STARTER_FEATURE_2_BUTTON_URL: '/ct',
  ...
  STARTER_PRICING_TEXT_2: 'Trial lesson 30min €9.9 (limited offer €4.9). We offer flexible course options to meet different learning needs.',
  STARTER_PRICING_TEXT_2_CN: '试课30min 9.9欧（限时折扣4.9欧）。我们提供灵活的课程选择，满足不同学习需求。',
  STARTER_PRICING_TEXT_2_RO: 'Lecție de probă 30 min 9,9€ (ofertă limitată 4,9€). Oferim opțiuni flexibile de cursuri pentru a satisface diferite nevoi de învățare.',
  ...
  STARTER_PRICING_2_TAG_CN: '推荐',
  STARTER_PRICING_2_TAG_RO: 'Recomandat',
  ...
  STARTER_TESTIMONIALS_ITEMS: [
    {
      ...
      STARTER_TESTIMONIALS_ITEM_AVATAR: '/images/starter/team/team-01.png',
    ...
    },
    {
      ...
      STARTER_TESTIMONIALS_ITEM_AVATAR: '/images/starter/team/team-02.png',
    ...
    },
    {
      ...
      STARTER_TESTIMONIALS_ITEM_AVATAR: '/images/starter/team/team-03.png',
  ...
  STARTER_FAQ_1_ANSWER: 'The trial lesson is 30 minutes, priced at €9.9 (limited offer €4.9). During the trial, the teacher will assess your Chinese level and learning goals, and create a personalized study plan for you.',
  STARTER_FAQ_1_ANSWER_CN: '试课时长30分钟，费用9.9欧（限时折扣4.9欧）。试课中老师会了解您的中文水平和学习目标，并为您制定个性化的学习方案。',
  STARTER_FAQ_1_ANSWER_RO: 'Lecția de probă durează 30 de minute, la prețul de 9,9€ (ofertă limitată 4,9€). Profesorul va evalua nivelul dumneavoastră de chineză și va crea un plan de studiu personalizat.',
  ...
  STARTER_CTA_DESCRIPTION: 'Trial lesson 30 min for only €9.9 (limited offer €4.9). Let us create a personalized study plan for you',
  STARTER_CTA_DESCRIPTION_CN: '试课30分钟仅需9.9欧（限时折扣4.9欧），让我们为您量身定制学习方案',
  STARTER_CTA_DESCRIPTION_RO: 'Lecție de probă 30 min doar 9,9€ (ofertă limitată 4,9€). Permiteți-ne să creăm un plan de studiu personalizat',
