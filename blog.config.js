...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jade Chinese Club', // 您的昵称 例如 tangly1024
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/images/starter/logo/mahjong-red.svg', // blog favicon 配置
  ...
  GREETING_WORDS:
    ...
    '欢迎来到Jade Chinese Club,专业中文教学，让学习更简单,一起探索中文的魅力,开启你的中文学习之旅',
